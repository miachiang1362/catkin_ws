...
(cl:defmethod cl:initialize-instance :after ((m <Beam-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Beam-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test2-srv:<Beam-request> is deprecated: use test2-srv:Beam-request instead.")))

(cl:ensure-generic-function 'In-val :lambda-list '(m))
(cl:defmethod In-val ((m <Beam-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-srv:In-val is deprecated.  Use test2-srv:In instead.")
  (In m))
...
(cl:defmethod cl:initialize-instance :after ((m <Beam-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Beam-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test2-srv:<Beam-response> is deprecated: use test2-srv:Beam-response instead.")))

(cl:ensure-generic-function 'ANG-val :lambda-list '(m))
(cl:defmethod ANG-val ((m <Beam-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-srv:ANG-val is deprecated.  Use test2-srv:ANG instead.")
  (ANG m))
